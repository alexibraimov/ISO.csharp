namespace ISOLib.Collections
{
    ...
    {
        private readonly static Language[] _languages = new Language[]
        {
        ...
        internal Languages() : base(_languages) { }
        ...
        /// </summary>
        /// <param name="langName">The name, Alpha-2 code, or Alpha-3 code of the language to retrieve.</param>
        ...
        public Language this[string langName]
        {
            get
            {
